...
// �õ��������߳������������õ����´�С��detrʹ�ã���Ϊ�䲻��Ҫ��������Ϊ32�ı��ʣ�ֱ���ҵ�һ�����ɣ�
...
/// <summary>
/// ������ͼ�񣨳��ߣ�resize��������target����ӽ�32�����Ĵ�С�����Զ̱߲�ֵ if forced=false;
/// ǿ��resize��hw��С��if forced=true.
/// </summary>
...
/// <summary>
/// ����cv::Mat����һ��tensor������������״��mem_info,һ��buffer[������ģ��]��tensor format
/// </summary>
