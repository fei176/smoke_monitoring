...
cv::Mat Yolo::call(cv::Mat& img, Ort::MemoryInfo& mem_info, Ort::RunOptions& run_options,
...
std::vector<Box> Yolo::call_box(cv::Mat& img, Ort::MemoryInfo& mem_info, Ort::RunOptions& run_options,
    transforms::DataFormat data_format) {
